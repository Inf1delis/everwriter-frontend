...
Object.defineProperty(exports, "__esModule", { value: true });
var LocalStorage_1 = __webpack_require__(/*! ./LocalStorage */ "./src/LocalStorage.tsx");
var DataStorage = {
    data: LocalStorage_1.default.read(),
...
var LocalStorage = {
    ...
    read: function () {
        ...
        var i = 0;
        while (true) {
            var str = localStorage.getItem('item' + i.toString());
            if (!str)
                return data;
...
var WorkSpace_1 = __webpack_require__(/*! ./content/WorkSpace */ "./src/components/content/WorkSpace.tsx");
__webpack_require__(/*! ./App.less */ "./src/components/App.less");
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement("div", { className: 'app_wrapper' },
...
/***/ "./src/components/content/Record.less":
/*!********************************************!*\
  !*** ./src/components/content/Record.less ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/components/content/Record.tsx":
/*!*******************************************!*\
  !*** ./src/components/content/Record.tsx ***!
  \*******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
__webpack_require__(/*! ./Record.less */ "./src/components/content/Record.less");
var Record = /** @class */ (function (_super) {
    ...
    Record.prototype.handleCheckBox = function (event) {
        this.setState({
            deleted: !this.state.deleted
        });
        alert('deleted');
    };
    Record.prototype.handleClick = function (event) {
        alert("Record Editing");
    };
    Record.prototype.render = function () {
        return (React.createElement("div", { className: 'record' },
            React.createElement("div", { onClick: this.handleClick }, this.props.title),
            React.createElement("input", { type: "checkbox", defaultChecked: this.state.deleted, onClick: this.handleCheckBox })));
    };
    return Record;
}(React.Component));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
var Record_1 = __webpack_require__(/*! ./Record */ "./src/components/content/Record.tsx");
__webpack_require__(/*! ./Record.less */ "./src/components/content/Record.less");
var DataStorage_1 = __webpack_require__(/*! ../../DataStorage */ "./src/DataStorage.tsx");
var data = DataStorage_1.default.list({
    current: -1,
    length: 0
}, function () { return true; });
function WorkSpace() {
    return (React.createElement("div", { className: "workspace" },
        React.createElement("div", { className: 'workspace_record' }, data.map(function (item, index) { return React.createElement(Record_1.default, { key: index, text: item.active, title: item.title }); }))));
}
...
/***/ "./src/components/header/AddButton.tsx":
/*!*********************************************!*\
  !*** ./src/components/header/AddButton.tsx ***!
  \*********************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "react");
var DataStorage_1 = __webpack_require__(/*! ../../DataStorage */ "./src/DataStorage.tsx");
var styles = __webpack_require__(/*! ./Header.less */ "./src/components/header/Header.less");
var AddButton = /** @class */ (function (_super) {
    ...
    AddButton.prototype.handleClick = function (event) {
        DataStorage_1.default.create({
            id: "31312312",
            ordinal: 0,
            status: 0,
            style: { color: "" },
    ...
    AddButton.prototype.render = function () {
        return (React.createElement("button", { className: styles.add, onClick: this.handleClick }, "AddButton"));
    };
    return AddButton;
}(React.Component));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
var AddButton_1 = __webpack_require__(/*! ./AddButton */ "./src/components/header/AddButton.tsx");
var StatusBar_1 = __webpack_require__(/*! ./StatusBar */ "./src/components/header/StatusBar.tsx");
__webpack_require__(/*! ./Header.less */ "./src/components/header/Header.less");
function Header() {
    return (React.createElement("div", { className: 'header' },
        React.createElement("div", { className: 'header_buttons' },
...
/***/ "./src/components/header/StatusBar.tsx":
/*!*********************************************!*\
  !*** ./src/components/header/StatusBar.tsx ***!
  \*********************************************/
/*! no static exports found */
...
var StatusBar = /** @class */ (function (_super) {
    ...
    StatusBar.prototype.handleClick = function (event) {
        this.setState({
            online: !this.state.online
        });
    };
    StatusBar.prototype.render = function () {
        return (React.createElement("div", { className: styles.status, onClick: this.handleClick },
            "Online: ",
            this.state.online ? "y" : "n"));
    };
    return StatusBar;
}(React.Component));
...
function editorReducer(state, action) {
    ...
    switch (action.type) {
        case types_1.ADD_RECORD:
            return {
                records: state.records.concat([action.payload.record])
            };
        case types_1.UPDATE_RECORD:
            return {
                records: state.records //FIXME
            };
        case types_1.DELETE_RECORD:
            return {
                records: state.records.filter(function (record) { return record.id !== action.payload.id; })
            };
        default:
            return state;
    }
}
var editorApp = redux_1.combineReducers({
